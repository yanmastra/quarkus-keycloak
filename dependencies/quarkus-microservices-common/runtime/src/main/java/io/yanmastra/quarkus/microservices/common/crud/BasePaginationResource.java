 ...
 */
public abstract class BasePaginationResource<Entity extends BaseEntity, Dto extends BaseDto<Entity>> extends io.yanmastra.quarkus.microservices.common.v2.crud.BasePaginationResource<Entity, Dto, String> {
    @Override
