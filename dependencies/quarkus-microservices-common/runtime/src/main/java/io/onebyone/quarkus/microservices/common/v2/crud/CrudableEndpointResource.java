 ...
 */
public abstract class CrudableEndpointResource<Entity extends BaseEntity<Id>, Dto extends BaseDto<Entity, Id>, Id> extends SelectablePaginationResource<Entity, Dto, Id> {
    /**
